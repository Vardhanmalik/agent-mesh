/**
 * Tiny zero-dependency dev server for the Edge + Copilot extension sample UI.
 *
...
server.listen(PORT, () => {
    console.log('');
    console.log('  Edge + Copilot extension sample UI');
    console.log('  ------------------------------------------------');
    console.log(`  Local:            http://localhost:${PORT}`);
    console.log(`  Proxying /api/*  -> ${ORCHESTRATOR_URL}`);
    console.log('');
    console.log('  Make sure the OrchestratorEngine.Api is reachable.');
    console.log('');
});
